...
class RigidCatheterEnv(DirectRLEnv):
    ...
    def _get_observations(self):
        ...
        # self.cam_z_pos += 0.02
        # self.camera_viewport.update_view_location((0.1, 0.1, self.cam_z_pos), (0.1, 0.1, 0.0013))
        return {"policy": obs}
